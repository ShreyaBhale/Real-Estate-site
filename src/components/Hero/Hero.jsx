                ...
                <div className="flexColStart hero-left">
                    ...
                    <div className="flexCenter stats">
                        <div className="flexColCenter stat">
                            <span>
                                <CountUp start={8800} end={9000} duration={4}/>          {/**libarry istalled countup */}
                            <span>+</span>
                            </span>
                        ...
                        <div className="flexColCenter stat">
                            <span>
                                <CountUp start={1950} end={2000} duration={4}/>          {/**libarry istalled countup */}
                            <span>+</span>
                            </span>
                        ...
                        <div className="flexColCenter stat">
                            <span>
                                <CountUp end={28} />          {/**libarry istalled countup */}
                            <span>+</span>
                            </span>
